...
string_db <- STRINGdb$new( version="11.5", species=9606, score_threshold=400, network_type="full", input_directory="/Users/niels/Documents/Uni/Stage/digital_twins/")
```
...
apply(data, 2, function(e) t.test(e ~ group)$p.val) %>% p.adjust("fdr")
```
